...
internal class SGame : Game1
{
    ...
    *********/
        ...
        : base(playerIndex, instanceIndex)
    {
        ...
        ObservableCollection<GameLocation> _locations;
        _locations = new ObservableCollection<GameLocation>(Game1.game1._locations); // Make sure types match
        // init SMAPI
    ...
    *********/
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        if (this.IsFirstTick)
        {
            ...
            this.Watchers = new WatcherCore(this.Input, (ObservableCollection<GameLocation>)_locations);
        }
