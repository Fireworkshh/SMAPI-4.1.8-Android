...
internal class AssemblyDefinitionResolver : IAssemblyResolver
{
    ...
    *********/
    ...
    {
        // 添加 .NET 核心库所在路径
        string dotnetCoreAppPath = "/storage/emulated/0/Android/data/app.SMAPIStardew/files/dotnet/shared/Microsoft.NETCore.App/8.0.11";

        if (Directory.Exists(dotnetCoreAppPath))
        {
            this.TryAddSearchDirectory(dotnetCoreAppPath);
        }

        // 添加 smapi-internal 目录路径
