...
public class ShopMenuFacade : ShopMenu, IRewriteFacade
{
    ...
    *********/
    ...
    {
        return new ShopMenu(ShopMenuFacade.GetShopId(context), null, currency, who, ToOnPurchaseDelegate(on_purchase), on_sell, playOpenSound: true);
     //666   return new ShopMenu(ShopMenuFacade.GetShopId(context), itemsForSale, currency, who, ToOnPurchaseDelegate(on_purchase), on_sell, playOpenSound: true);
    }
    ...
    {
        return new ShopMenu(shopId, null, currency, who ,ToOnPurchaseDelegate(on_purchase), on_sell, playOpenSound);
