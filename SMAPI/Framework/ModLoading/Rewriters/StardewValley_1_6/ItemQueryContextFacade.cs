...
public class ItemQueryContextFacade : ItemQueryContext, IRewriteFacade
{
    ...
    *********/
    ...
    public static ItemQueryContext Constructor(GameLocation location, Farmer player, Random random,string sourcePhrases)
    {
        return new ItemQueryContext(location, player, random, sourcePhrases);
    }
